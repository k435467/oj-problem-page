...
class TestModeClass {
  ...
  SubmitCE() {
    postURL = this.postCEurl;
    document.getElementById('submitBtn').click();
  }
  SubmitTLE() {
    postURL = this.postTLEurl;
    document.getElementById('submitBtn').click();
  }
  SubmitWA() {
    postURL = this.postWAurl;
    document.getElementById('submitBtn').click();
  }
  SubmitMLE() {
    postURL = this.postMLEurl;
    document.getElementById('submitBtn').click();
  }
}
